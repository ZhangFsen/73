...
public class FloatingWindowService extends Service {
    static final String ACTION_REFRESH_NOTIFICATION = "com.qingji.memo.REFRESH_FLOAT_NOTIFICATION";
    private static final String FLOAT_CHANNEL_ID = "qingji_float";
    ...
    private void startAsForegroundService() {
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O && nm != null) {
                ...
                channel.setDescription("保持轻记悬浮按钮稳定显示");
            ...
            Notification.Builder notificationBuilder = builder
                    ...
                    .setContentTitle("轻记悬浮窗运行中")
                    .setContentText("点击悬浮按钮快速记录")
                    .setContentIntent(pi)
                    .setOngoing(true)
                    .setShowWhen(false)
    ...
    private void createFloatingButton() {
        ...
        SharedPreferences sp = getSharedPreferences("qingji_native", MODE_PRIVATE);
    ...
    private int readThemeColor() {
        String color = getSharedPreferences("qingji_native", MODE_PRIVATE).getString("float_color", "#12b981");
    ...
    private void closeFloatingWindow() {
        getSharedPreferences("qingji_native", MODE_PRIVATE)
                .edit()
    ...
    public void onTaskRemoved(Intent rootIntent) {
        ...
        hideCloseMenuNow();
        if (getSharedPreferences("qingji_native", MODE_PRIVATE).getBoolean("float_enabled", false)) {
            try {
