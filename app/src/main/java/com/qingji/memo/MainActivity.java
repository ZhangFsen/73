...
public class MainActivity extends Activity {
    public static final String CHANNEL_ID = "qingji_reminder";
    ...
    private void syncFloatingWindowAfterPermission() {
        SharedPreferences sp = getSharedPreferences("qingji_native", Context.MODE_PRIVATE);
    ...
    private static String applyLauncherIconTheme(Context context, String theme) {
        ...
        try {
            SharedPreferences sp = context.getSharedPreferences("qingji_native", Context.MODE_PRIVATE);
    ...
    public static class AndroidBridge {
        ...
        public String exportBackupFile(String filename, String content) {
            if (filename == null || filename.trim().length() == 0) filename = "轻记备份.json";
        ...
        public String exportTextFile(String filename, String content) {
            if (filename == null || filename.trim().length() == 0) filename = "轻记导出.txt";
            filename = filename.replaceAll("[\\/:*?\"<>|]", "_");
        ...
        public String exportPngFile(String filename, String base64Png) {
            if (filename == null || filename.trim().length() == 0) filename = "轻记图片.png";
            filename = filename.replaceAll("[\\/:*?\"<>|]", "_");
        ...
        public void sharePngFile(String filename, String base64Png) {
            ...
            try {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                    values.put(MediaStore.Images.Media.RELATIVE_PATH, Environment.DIRECTORY_PICTURES + "/轻记");
                }
        ...
        private static String doPostJson(String urlText, String jsonBody) {
            ...
            try {
                ...
                conn.setRequestProperty("User-Agent", "Qingji-Mobile/1.0.0 AndroidBridge");
